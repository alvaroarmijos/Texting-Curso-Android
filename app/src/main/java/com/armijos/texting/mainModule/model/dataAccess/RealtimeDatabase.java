...
public class RealtimeDatabase {
    ...
    * */
    ...
    public void subscribeToUserList(String myUid, final UserEventLinstener listener){
    ...
    public void subscribeToRequests(String email, final UserEventLinstener listener){
